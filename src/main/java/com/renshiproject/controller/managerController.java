...
public class managerController {
    ...
    @ResponseBody
    public String addAttendance(int employee_id,String employee_name, String dept_name, String position, int absence, int late, String year,String month)
    {
        ...
        int re=0;
        try {
            re=managerService.addAttendance(e,dept_name,position,absence,late,date);
        }
        catch (Exception e1)
        {
            return "0";
    ...
    @RequestMapping("/searchAllAttendance")
    public String searchAllAttendance(Model model)
    {
        return "";
    }
...
//			创建表头
    ...
    {
        List<attendance> all=managerService.findAllAttendance();
        model.addAttribute("allAttendance",all);
        return "manager/appraisal";
    }
    ...
    {
        List<position> allPosition=iAdminService.findAllPosition(1,9999);
        List<department> allDept=iAdminService.findAllDepartment();
        model.addAttribute("allPosition",allPosition);
        model.addAttribute("allDept",allDept);
        return "/manager/appraisalAdd";
    }
