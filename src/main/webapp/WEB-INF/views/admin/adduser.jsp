...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/admin/manageEmployee/addEmployee.do"
				  method="post">
				<!-- 正文区域 -->
					...
					<div class="panel panel-default">
						...
						<div class="row data-type">
							...
							<div class="col-md-4 data">
								...
								<select class="col-md-4 data" name="dept_id">
							...
							<div class="col-md-4 data">
								...
								<select class="col-md-4 data" name="position_id">
							...
							<div class="col-md-2 title">初始密码</div>
							<div class="col-md-4 data">
