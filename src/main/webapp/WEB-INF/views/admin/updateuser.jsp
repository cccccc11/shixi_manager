			...
			<form action="/admin/manageEmployee/updateEmployee.do"
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="phonNumber"
								   placeholder="电话" value="${user.phoneNumber}">
						</div>

						<div class="col-md-2 title">性别</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="gender"
								   placeholder="性别" value="${user.gender}">
						</div>

						<div class="col-md-2 title">部门名称</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="deptId"
								   placeholder="部门名称" value="${user.deptId}">
						</div>

						<div class="col-md-2 title">职位名称</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="positionId"
								   placeholder="职位名称" value="${user.positionId}">
						</div>
